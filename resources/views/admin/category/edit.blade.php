            ...
            <div class="col-xl-12 mx-auto">
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <form action="{{ route('save_category') }}" method="POST" class="row g-3"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="col-12">
                                <label for="inputFirstName" class="form-label">Category Name</label>
                                <input type="text" name="name" class="form-control"
                                    value="{{ $data['name'] ?? (old('name') ?? '') }}" placeholder="Category Name..."
                                    id="inputFirstName">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="icon" class="form-control"
                                    ...
                                    placeholder="Category Icon code..." id="inputFirstName">
                            </div>
                            <div class="col-12">
