                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <ul class="nav nav-tabs small-tab mb-3" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="places-tab" data-bs-toggle="tab" data-bs-target="#places"
                                type="button" role="tab" aria-controls="places" aria-selected="true">Places</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="car-tab" data-bs-toggle="tab" data-bs-target="#car" type="button"
                                role="tab" aria-controls="car" aria-selected="false">Cars</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="real-tab" data-bs-toggle="tab" data-bs-target="#real" type="button"
                                role="tab" aria-controls="real" aria-selected="false">Real Estate</button>
                        </li>
                        <li class="nav-item" role="presentation">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>San Francisco, USA
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                                </div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>102 Satirio, Canada
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                                </div>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-4"><i class="lni lni-coffee-cup"></i></div>
                                                        <span class="cats-title">Coffee &amp; Bars</span>
                                                    </a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-5"><i class="lni lni-shopping-basket"></i>
                                                        </div><span class="cats-title">Shopping Mall</span>
                                                    </a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>Warmingham, London
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                                </div>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-5"><i class="lni lni-surf-board"></i></div>
                                                        <span class="cats-title">Spa &amp; Salon</span>
                                                    </a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>Liverpool, London
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                                </div>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-6"><i class="lni lni-burger"></i></div><span
                                                            class="cats-title">Food Services</span>
                                                    </a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>Metrio General Store
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                                </div>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-7"><i class="lni lni-car"></i></div><span
                                                            class="cats-title">Tour &amp; Travels</span>
                                                    </a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>Old California, USA
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                                </div>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-8"><i class="lni lni-gift"></i></div><span
                                                            class="cats-title">Wedding</span>
                                                    </a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
